...
/* USART3 Logic Analyzer pins: PD8=TX, PD9=RX */
#define LOGIC_USART3_TX_Pin GPIO_PIN_8
#define LOGIC_USART3_TX_GPIO_Port GPIOD
#define LOGIC_USART3_RX_Pin GPIO_PIN_9
#define LOGIC_USART3_RX_GPIO_Port GPIOD
